<%-- 
    ...
    Created on : Sep 30, 2024, 3:43:22 PM
                    ...
                    <%
                        if(request.getParameter("s1")!=null){
                            ...
                            if(request.getParameter("acc_status").equals("Accepted")){
                                ...
                                String from = "customerproject404nf@gmail.com";
                                String user = from;
                                String pwd = "nowdlnospvmgsoth";
                                String to = mailid;
